...
#define ADC_NOTCH_CHANNEL           9

#define PIN_GAIN_SLCT_1_PORT        'C'
#define PIN_GAIN_SLCT_1_PIN         8

#define PIN_GAIN_SLCT_2_PORT        'C'
#define PIN_GAIN_SLCT_2_PIN         9
...
#define PIN_STATUS_LED_PORT         'A'
#define PIN_STATUS_LED_PIN          6

#define PIN_MEAS_LED_PORT           'A'
#define PIN_MEAS_LED_PIN            7

#define PIN_EXCITE_LED_PORT         'C'
#define PIN_EXCITE_LED_PIN          7

#define PIN_ERR_LED_PORT            'B'
#define PIN_ERR_LED_PIN             1

#define PIN_NINA_TX_PORT            'C'
#define PIN_NINA_TX_PIN             10

#define PIN_NINA_RX_PORT            'A'
#define PIN_NINA_RX_PIN             1
...
#define PIN_NINA_DTR_PORT           'C'
#define PIN_NINA_DTR_PIN            12

#define PIN_NINA_LED_RED_PORT       'C'
#define PIN_NINA_LED_RED_PIN        1

#define PIN_NINA_LED_BLUE_PORT      'C'
#define PIN_NINA_LED_BLUE_PIN       2

#define PIN_NINA_LED_GREEN_PORT     'C'
#define PIN_NINA_LED_GREEN_PIN      3
