...
| **PC12** | `NINA_TX` | **UART4 TX** | Bluetooth Module TX. |
| **PA11** | `NINA_RST` | **GPIO OUT** | Bluetooth rest. |
| **PC4** | `NINA_LED_BLUE` | **GPIO OUT** | Bluetooth led. |
| **PC2** | `NINA_LED_GREEN` | **GPIO OUT** | Bluetooth led. |
| **PC15** | `NINA_LED_RED` | **GPIO OUT** | Bluetooth led. |
